...
struct Exercise {
	...
	enum ExerciseEnum: CustomStringConvertible {
		...
		var description: String {
			switch self {
				case .squat:
					return NSLocalizedString("Squat", comment: "the name of an exercise")
			   case .stepUp:
					return NSLocalizedString("Step Up", comment: "the name of an exercise")
				case .burpee:
					return NSLocalizedString("Burpee", comment: "the name of an exercise")
				case .sunSalute:
